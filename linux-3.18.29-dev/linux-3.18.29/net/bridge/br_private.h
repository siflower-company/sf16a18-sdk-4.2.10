...
//brport disable input
#define BR_DISABLE_INPUT	0x00000800
//enable net isolate between wifi aps
#define BR_NETISOLATE	0x00001000

	//port group for froward pkt between ports in bridge
	unsigned long 			group;
