...
struct i2s_platform_data {
	...
	#define SF_I2S_INTERFACE_I2S0   (1 << 2)
	#define SF_I2S_INTERFACE_I2S1  	(1 << 3)
	#define SF_I2S_MASTER		(1 << 4)
	#define SF_I2S_SLAVE		(1 << 5)
	unsigned int cap;
	int channel;
	u32 snd_fmts;
	u32 snd_rates;
...
#define I2S_MASTER_I2S0_MODE		((0 << 4) | (1 << 2) | (1 << 1) | (0 << 0))
#define I2S_SLAVE_I2S0_MODE		((1 << 4) | (0 << 2) | (0 << 1) | (1 << 0))
