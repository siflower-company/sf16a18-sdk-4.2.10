...
Currently available applets include:
	...
	date, dd, depmod, devmem, df, dirname, dmesg, du, echo, egrep, env,
	expr, false, fdisk, fgrep, find, free, fsync, getty, grep, gunzip,
	gzip, halt, head, hexdump, hostid, hwclock, id, ifconfig, init,
	insmod, kill, killall, less, linuxrc, ln, logger, login, ls, lsmod,
	md5sum, mdev, mkdir, mkdosfs, mkfifo, mkfs.vfat, mknod, mkswap,
	mktemp, modinfo, modprobe, mount, mv, nc, netstat, nice, nslookup,
	ntpd, passwd, pgrep, pidof, ping, ping6, pivot_root, poweroff,
	printf, ps, pwd, readlink, reboot, reset, rm, rmdir, rmmod, route,
	sed, seq, sh, sleep, sort, start-stop-daemon, strings, switch_root,
	sync, sysctl, tail, tar, tee, telnet, telnetd, test, time, top,
