...
--	/* modified by ivan 2015.7.31 remove "Firewall" under "Status" */
--	entry({"admin", "status", "iptables"}, call("action_iptables"), _("Firewall"), 2).leaf = true

	entry({"admin", "status", "routes"}, template("admin_status/routes"), _("Routes"), 3)
	entry({"admin", "status", "syslog"}, call("action_syslog"), _("System Log"), 4)

--	/* start modified by ivan 2015.7.31 remove "Kernel Log" and "Processes" under "Status" */
--	entry({"admin", "status", "dmesg"}, call("action_dmesg"), _("Kernel Log"), 5)
--	entry({"admin", "status", "processes"}, cbi("admin_status/processes"), _("Processes"), 6)
--	/* end modified by ivan 2015.7.31 remove "Kernel Log" and "Processes" under "Status" */
...
--	/* start modified by ivan 2015.7.31 remove "Connections" under "Status - Realtime Graphs" */
--	entry({"admin", "status", "realtime", "connections"}, template("admin_status/connections"), _("Connections"), 4).leaf = true
--	entry({"admin", "status", "realtime", "connections_status"}, call("action_connections")).leaf = true
--	/* end modified by ivan 2015.7.31 remove "Connections" under "Status - Realtime Graphs" */
