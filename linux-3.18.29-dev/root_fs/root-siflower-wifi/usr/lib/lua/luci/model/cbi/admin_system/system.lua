...
--/* modified by ivan 2015.7.31 remove "Logging" under "System - System - System Properties" */
--s:tab("logging",  translate("Logging"))

--/* modified by ivan 2015.7.31 change the tab name */
...
--/* start modified by ivan 2015.7.31 remove "Logging" under "System - System - System Properties" */
--[[
...
--]]
--/* end modified by ivan 2015.7.31 remove "Logging" under "System - System - System Properties" */
...
--/* modified by ivan 2015.8.17 to mark if language changed */
local lang_changed = false

function o.cfgvalue(...)

	--/* start modified by ivan 2015.8.17 if language changed then refresh current webpage */
	if lang_changed then
		luci.http.redirect(luci.dispatcher.build_url("admin/system/system"))
	end
	--/* end modified by ivan 2015.8.17 if language changed then refresh current webpage */
...
--/* start modified by ivan 2015.7.31 remove "Design" under "System - System - System Properties - Language" */
--[[
...
--]]
--/* end modified by ivan 2015.7.31 remove "Design" under "System - System - System Properties - Language" */
