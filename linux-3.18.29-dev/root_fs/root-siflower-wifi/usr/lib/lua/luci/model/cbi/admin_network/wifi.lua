...
s:tab("encryption", translate("General Setup"))
--s:tab("general", translate("General Setup"))
s:tab("macfilter", translate("MAC-Filter"))
s:tab("advanced", translate("Advanced Settings"))

xessid=s:taboption("encryption", Value, "ssid", translate("<abbr title=\"Extended Service Set Identifier\">ESSID</abbr>"))
xessid.datatype="maxlength(32)"

mode = s:taboption("encryption", ListValue, "mode", translate("Mode"))
mode.override_values = true
mode:value("ap", translate("Access Point"))
-- mode:value("sta", translate("Client"))
-- mode:value("adhoc", translate("Ad-Hoc"))

bssid = s:taboption("encryption", Value, "bssid", translate("<abbr title=\"Basic Service Set Identifier\">BSSID</abbr>"))
...
function encr.write(self, section, value)
	...
	local c = "ccmp" --tostring(cipher:formvalue(section))
