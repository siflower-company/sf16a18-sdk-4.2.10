...
define KernelPackage/sound-soc-siflower
  TITLE:=Siflower SoC sound support
  KCONFIG:= \
...
define KernelPackage/sound-soc-siflower/description
 support for the siflower soundcard
endef

$(eval $(call KernelPackage,sound-soc-siflower))
