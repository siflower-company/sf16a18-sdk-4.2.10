...
define Profile/SF16A18-P10-FLASH-V2
 NAME:= SF16A18 P10 FLASH V2
 PACKAGES:=\
	vsftpd vsftpd-tls\
	netdiscover iwinfo luci-lib-json kmod-button-hotplug kmod-reset-button
endef

define Profile/SF16A18-P10-FLASH-V2/Description
 Support for siflower p10 flash boards v1.0
endef

define Profile/SF16A18-P10-FLASH-V2/Config
...
$(eval $(call Profile,SF16A18-P10-FLASH-V2))
