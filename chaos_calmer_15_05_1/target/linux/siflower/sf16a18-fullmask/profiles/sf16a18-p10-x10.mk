...
define Profile/SF16A18-P10M-X10
 NAME:= SF16A18 P10M X10
 PACKAGES:=\
	iperf \
	vsftpd vsftpd-tls\
...
define Profile/SF16A18-P10M-X10/Description
 Support for siflower x10 boards v1.0 which use gmac as wan
endef

define Profile/SF16A18-P10M-X10/Config
...
$(eval $(call Profile,SF16A18-P10M-X10))
