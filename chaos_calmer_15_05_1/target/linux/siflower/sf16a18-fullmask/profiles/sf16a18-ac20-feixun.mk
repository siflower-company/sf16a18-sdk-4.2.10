...
define Profile/SF16A18-AC20-FEIXUN
 NAME:= SF16A18 AC20 FEIXUN
 PACKAGES:=\
	iperf \
	vsftpd vsftpd-tls\
...
define Profile/SF16A18-AC20-FEIXUN/Description
 Support for siflower ac20 boards v1.0 which use realtek giga switch
endef

define Profile/SF16A18-AC20-FEIXUN/Config
...
$(eval $(call Profile,SF16A18-AC20-FEIXUN))
