...
define Profile/SF16A18-AC20-INTEL
 NAME:= SF16A18 AC20 INTEL
 PACKAGES:=\
	iperf \
	vsftpd vsftpd-tls\
...
define Profile/SF16A18-AC20-INTEL/Description
 Support for siflower ac20 boards v1.0 which use intel giga switch
endef

define Profile/SF16A18-AC20-INTEL/Config
...
$(eval $(call Profile,SF16A18-AC20-INTEL))
