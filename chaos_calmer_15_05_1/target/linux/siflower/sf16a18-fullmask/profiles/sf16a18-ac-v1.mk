...
define Profile/SF16A18-ACCTL-V1
 NAME:= SF16A18 ACCTL V1
 PACKAGES:=\
	iperf \
	vsftpd vsftpd-tls\
	libwebsockets ssst subcloud libcurl ndscan tc curl netdetect netdiscover\
	luasql-sqlite3 luci-ssl luci-lib-json openssl-util tcpdump kmod-button-hotplug\
	kmod-reset-button wandetect kmod-sf-ts kmod-ipt-ipset ipset
endef

define Profile/SF16A18-ACCTL-V1/Description
 Support for siflower ac boards v1.0
endef

define Profile/SF16A18-ACCTL-V1/Config
...
$(eval $(call Profile,SF16A18-ACCTL-V1))
